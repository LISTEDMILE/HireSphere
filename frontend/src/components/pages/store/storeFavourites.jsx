...
export default function StoreFavourites() {
    ...
    const fetchFavouriteJobs = async () => {
      try {
        const response = await fetch(
          `https://localhost:3000/store/onlyFavourites`,
          {
            method: "GET",
            credentials: "include",
            headers: {
        ...
        const applyResponse = await fetch(
          `https://localhost:3000/store/appliedJobs`,
          {
            method: "GET",
            credentials: "include",
            headers: {
  ...
  const handleApply = async (jobId) => {
    try {
      await fetch(`https://localhost:3000/store/apply/${jobId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleFavourite = async (jobId) => {
    try {
      await fetch(`https://localhost:3000/store/favourite/${jobId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
