...
export default function Offers() {
    ...
    const handleAccept = async (profileId) => {
        try{
            ...
            setOffers((prevOffers) =>
                prevOffers.map((offer) => offer.profile._id == profileId ? { ...offer, status: "accepted" } : offer)
        );
    ...
    const handleReject = async (profileId) => {
        try {
            ...
            setOffers((prevOffers) =>
                prevOffers.map((offer) => offer.profile._id == profileId ? { ...offer, status: "rejected" } : offer)
            );
        } catch (error) {
          ...
          <ul className="gap-8 mt-12 flex flex-col items-center w-full ">
            {offers.map((offer) => (
                ...
                <div className="flex gap-24 ">
                  ...
                  <div className="w-full flex flex-col gap-4">
                    ...
                    <div className="mt-2 flex gap-3">
                      ...
                      <p className="text-white text-xl">{offer.profile.profileName}</p>
                    </div>
              ...
              <div className="mt-6 bg-[#0e201c8f] flex flex-col gap-3 p-8 rounded-lg shadow-inner">
                ...
                <div className="flex gap-3 items-center">
                  <strong className="text-gray-400 text-lg">Designation:</strong>{" "}
                  <p className="text-white">
